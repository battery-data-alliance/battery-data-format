    ...
    (
        ...
        SampleCase(
            ...
            expected_columns={
                ...
                "schedule_charging_capacity_ah": ColExpect("Charge_Capacity(Ah)", 1.0),
                "schedule_discharging_capacity_ah": ColExpect("Discharge_Capacity(Ah)", 1.0),
                "schedule_charging_energy_wh": ColExpect("Charge_Energy(Wh)", 1.0),
                "schedule_discharging_energy_wh": ColExpect("Discharge_Energy(Wh)", 1.0),
            },
            marks=(
                pytest.mark.network,
                pytest.mark.skipif(
